          ...
          <div className="flex justify-end gap-4">
            {url && (
              <a
                ...
                target="_blank"
                rel="norefer"
                className="inline-flex items-center gap-2 px-2 py-1 font-semibold tracking-wider text-gray-800 transition-colors duration-500 bg-transparent border border-gray-800 rounded-md outline-none cursor-pointer lg:px-4 focus-within:font-semibold focus-within:bg-transparent opacity-60 border-opacity-60 focus-within:opacity-100 focus-within:border-opacity-100 dark:text-neutral-100 dark:border-neutral-100"
              >
            ...
            {githubUrl && (
              <a
                ...
                target="_blank"
                rel="norefer"
                className="inline-flex items-center gap-2 px-2 py-1 font-medium tracking-wider transition-colors duration-500 bg-gray-800 border border-gray-800 rounded-md outline-none cursor-pointer lg:px-4 focus-within:font-semibold focus-within:bg-transparent text-neutral-100 focus-within:text-gray-800 focus-within:border-gray-800 dark:bg-neutral-100 dark:focus-within:bg-transparent dark:border-neutral-100 dark:text-gray-800 dark:font-semibold dark:focus-within:text-neutral-100"
              >
                View <FiGithub />
              </a>
            )}
